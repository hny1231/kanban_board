      ...
      setCardInfo((prevState) => {
        return {
          ...
          tagList: responseData.tags
            ? Object.values(responseData.tags).map((tags) => tags.tag_name)
            : "",
    ...
    <div>
      ...
      >
        <A.Div className="modal_box">
          ...
          <A.Div className="modal_middle">
            ...
            <A.Div className="des">
              <A.Div className="cardWrap2">
                <A.Div className="classDes"> Description </A.Div>
              </A.Div>
              <A.Textarea
          ...
          {!admin && (
            <A.Input type="button" onClick={deleteCard} value="삭제"></A.Input>
          )}
        </A.Div>
      </Modal>
    </div>
